...
🚀 **Live demo:** [tech-prep-three.vercel.app](https://tech-prep-three.vercel.app/)
...
- **Teacher Agent** — when you score poorly or answer "idk", a dedicated AI explains the concept in beginner-friendly terms with examples
- **Second Attempt** — after seeing the explanation, you get one retry; the grade is overwritten if you do better
...
- **Telegram Bot** — practice on your phone via voice or text messages; link your account with a 6-digit code from the web app
...
| AI | Anthropic Claude (coach + evaluator + teacher), OpenAI Whisper (voice) |
...
TechPrep/
├── backend/
│   ├── agents/          # Coach agent (tool-use loop), interview evaluator, teacher agent
│   ├── bot/             # Telegram bot
...
Backend and Telegram bot are deployed on [Railway](https://railway.app), frontend on [Vercel](https://vercel.com).
...
| `/link <code>` | Link to your web app account (get the 6-digit code from the app) |
